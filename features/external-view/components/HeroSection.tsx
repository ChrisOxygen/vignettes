    ...
    <main className="lg:min-h-screen relative h-full grid grid-rows-[100px_1fr] p-4 sm:p-6 md:p-8">
      ...
      <section className="relative grid place-items-center row-start-2 z-10 py-20 px-6 text-center ">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="scroll-m-20 text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-tight mb-6 text-white">
            Your Complete{" "}
          ...
          <p className="text-lg leading-8 text-white/90 mb-8 max-w-2xl mx-auto">
